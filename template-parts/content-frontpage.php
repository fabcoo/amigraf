								...
								<div class="col-md-8">
													...
													<?php if(get_field('profils_accueil')): ?>
														<?php while(has_sub_field('profils_accueil')): ?>
															<a href="<?php the_sub_field('lien_profil'); ?>"><div class="entreprise">
																<h2><?php the_sub_field('titre_profil'); ?></h2>
																<p class="textchoix"><i class="fas fa-chevron-right"></i><?php the_sub_field('text_profil'); ?></p>
															</div></a>
														<?php endwhile ?>
													<?php endif; ?>
 ...
 <div class="popup">
      ...
      <div class="hovercontent">
			 ...
			 foreach ($postslist as $post) :  setup_postdata($post); ?>
								 ...
								 <p class=""><?php the_title(); ?> le <div class="date-eventpop"><?php the_time ('j M.'); ?> </div> </p>
