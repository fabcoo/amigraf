...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="row padding-profil">
																...
																<div class="row">
																					<div class="col-md-5">
																									...
																									<div class="pictopart1">
																																	...
																																	<p class="textpicto"><?php the_field('titre_popin_une') ?>
																																	</div></a>
																									</div>
																					</div>
							...
							<div class="col-md-6">
								<video autoplay muted loop class="Videoentreprise">
										<source src="<?php the_field('video_entreprise') ?>" type="video/mp4"> <!-- 340x300px -->
								</video>
							</div>
				</div>
	</div>
	...
	<div class="container-fuid padding-large">
			<div class="row">
					<div class="col-md-7 formulaire">
							<p><?php the_field('intro_formulaire') ?></p>
							<hr>
							<h2><?php the_field('titre_formulaire') ?></h2>
							<?php echo do_shortcode( '[contact-form-7 id="229" title="Formulaire de contact entreprise"]' ); ?>
							<p class="champoblig">* champs obligatoire </p>
					</div>
					<div class="col-md-5 lien-formation">
						<?php if(get_field('lien_formation')): ?>
							<?php while(has_sub_field('lien_formation')): ?>
								<a href="/amigraf/recherche">
									<div class="fin-formation">
